...
export function FileDropzone<T>({
  ...
  return (
    <div className="space-y-3">
      ...
      >
        <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-md border border-zinc-800 bg-zinc-900 text-zinc-400">
          {isProcessing ? (
      ...
      {lastUploaded ? (
        <div className="flex items-center justify-between rounded-md border border-zinc-800 bg-zinc-900/50 px-3 py-2">
          <p className="truncate text-xs text-zinc-400">
            Loaded: <span className="text-zinc-200">{lastUploaded}</span>
          </p>
...
export function StatusMessage({ message, onDismiss }: StatusMessageProps) {
  ...
  return (
    <div className="flex items-start justify-between gap-3 rounded-md border border-emerald-900/50 bg-emerald-950/20 px-3 py-2">
...
export function ErrorMessage({ message, onDismiss }: ErrorMessageProps) {
  ...
  return (
    <div className="flex items-start justify-between gap-3 rounded-md border border-red-900/40 bg-red-950/20 px-3 py-2">
